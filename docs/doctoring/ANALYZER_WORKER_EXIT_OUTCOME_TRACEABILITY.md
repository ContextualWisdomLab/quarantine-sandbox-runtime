...
No GREEN is claimed until one unchanged exact descendant executes the nonzero-completed rejection, zero-completed acceptance, zero-exit semantic-failure acceptance, full fmt/test/Clippy/rustdoc, complete owned-production/branch coverage, applicable review/security/confinement gates, and parent/protected integration.
