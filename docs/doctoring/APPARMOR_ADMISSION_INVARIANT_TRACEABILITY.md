...
This documentation descendant intentionally reacquires native exact-head CI for the source repair. Neither the `3cfdc77...` GREEN nor the one-shot GREEN transfers to the moved head.
