...
- Exact root `0f765af1a4eea83029febee3b24c55cd7e7ce4e1` had CI `33915538506`, Security Scan `33915538442`, SAST `33915538578`, and CodeQL `33915538508` cancelled before usable execution evidence in the current run. All four were re-run rather than accepted; the latest attempts are queued, so no executed issue #24 RED is claimed.
...
- Main command/release descendants #6 → #9 → #10 → #13 → #14 `16309964ca76502363a5aa2b04ad37a42034f61d`; artifact-analysis #18 `572330f1f611e66c1cbf41debe371aa67ad81705` non-force adopts current #14 while preserving only its owned RED/reference overlay. Predecessor checks never transfer.
- #14 CI `33924706282` attempt 1 was cancelled before checkout and was re-run. Attempt 2 remains queued; #18 CI `33924793758` also remains pre-checkout queued. Issues #25/#26/#27 and the #18 artifact-analysis RED have therefore not executed on current exact ancestry.
