...
- #21 carries #20's collision-resistant runtime invocation identity RED and #40's post-create lifecycle-ownership RED. #40 requires every post-create application-service `start`/inspect/top/port/stop/remove operation to remain bound to the exact long ID returned by successful `podman create`; generated `qsr-app-*` remains correlation/public metadata rather than destructive authority.
...
The dependency chain is being repaired non-force after the root movement. #6 now adopts root `e9ee847...` at `8daab565bba1b61e605488c080eb28de371990a3`; #9 adopts that parent at `fa1a0faf83656777e2ac34d3f4a641f7b5c76543`; #10 adopts #9 at `5feaa1b4df77946db76f2d735c910a0ee34a37ad`; #13 adopts #10 at `bc79f7ec972908b5a5e63fe32b1b57a360011ce3`. #14 first adopted #13 and the repaired CI workflow at `78a89186ccc0b4c0032720872ccf34ac9c41f6e9`; this ledger update moves #14 again and therefore requires another fresh exact-head execution. #18 must adopt the resulting final #14 head non-force. Direct RED-only #19/#21/#23 must independently adopt current root while preserving their own deltas. No child delta is closed or discarded, and predecessor checks never transfer.
...
1. Finish non-force adoption of the root issue #24 repair through #14 → #18 and the direct #19/#21/#23 descendants while preserving each child-owned delta.
...
3. Execute #19, #23, and #21's #20/#40 REDs on current root ancestry; add only their smallest causal GREENs before live resource/network proofs.
4. Execute #14 issues #25–#39 in causal order where dependencies require it; do not let a later launch-intent or applied-state fix bypass #25's pre-payload proof or #33/#36 ownership.
