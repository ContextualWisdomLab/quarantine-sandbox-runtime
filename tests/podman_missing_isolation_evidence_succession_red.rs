...
fn policy() -> IsolationPolicy {
    IsolationPolicy {
        policy_id: "missing_isolation_evidence_succession_v1".to_owned(),
...
fn request() -> ApplicationServiceRequest {
    ApplicationServiceRequest {
        ...
        request_id: "missing_isolation_evidence_succession_request".to_owned(),
...
impl Default for Fixture {
    fn default() -> Self {
        Self {
            container: json!([{
                "Id": "missing-evidence-container-id",
